...
//////////////////////////////////////////////
const char SSID_ESP[] = "Yanci";         //Give EXACT name of your WIFI
const char SSID_KEY[] = "9362655587";             //Add the password of that WIFI connection
const char* host = "visualiot.000webhostapp.com";  //Add the host without "www" Example: electronoobs.com
